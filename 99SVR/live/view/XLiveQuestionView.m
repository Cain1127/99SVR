...
- (id)initWithFrame:(CGRect)frame
{
    ...
    UIView *liveQuestion = [[UIView alloc] initWithFrame:Rect(0,kVideoImageHeight+kRoom_head_view_height, kScreenWidth, kScreenHeight-kRoom_head_view_height-kVideoImageHeight)];
