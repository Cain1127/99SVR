...
- (void)initUIHead
{
    ...
    _txtName = [self createTextField:Rect(lbl1.x+lbl1.y+5, lbl1.y, kScreenWidth-lbl1.x*2-lbl1.width, 30)];
    ...
    [_checkAgree setTitleColor:UIColorFromRGB(0x00) forState:UIControlStateNormal];
