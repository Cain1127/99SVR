...
enum {
    ...
    Sub_Vchat_HallPERSECRes = 							10037,//查看个人秘籍
    Sub_Vchat_HallSystemInfoRes = 					10038,//查看系统消息
    ...
    Sub_Vchat_UserPayRes = 								10291,				//付费响应
    
    Sub_Vchat_GetUserAccountBalanceReq = 	10292,  //查询账户余额请求
    Sub_Vchat_GetUserAccountBalanceRes = 	10293,  //查询账户余额响应
    
    Sub_Vchat_TextRoomEmoticonRes = 			10294,   //专属表情列表
    
    Sub_Vchat_GetUserInfoReq = 						10295, //查询用户个人资料请求
    Sub_Vchat_GetUserInfoRes = 						10296, //查询用户个人资料响应
    Sub_Vchat_GetTeacherInfoRes = 				10297, //查询文字直播讲师个人资料响应
    Sub_Vchat_GetUserInfoErr = 						10298, //查询用户个人资料请求
    
    Sub_Vchat_GetUserGoodStatusReq = 			10299,  //查询用户商品请求
    Sub_Vchat_GetUserGoodStatusRes = 			10300,  //查询用户商品响应
