...
-(void)iniUI{
    ...
    self.lineChartView.lineColors = @[[UIColor orangeColor],[UIColor blueColor]];
    ...
    self.lineChartView.backgroundColor = [[UIColor blueColor] colorWithAlphaComponent:0.2];
...
-(void)setTopTitItems:(NSArray *)topTitItems{
    ...
    for (int i=0; i!=_topTitItems.count; i++) {
        ...
        if (i==0) {
            ...
            self.topMenuLineView.backgroundColor = [UIColor yellowColor];
...
-(UIView *)topMenuView{
    ...
    if (!_topMenuView) {
        ...
        _topMenuView.backgroundColor = [[UIColor greenColor] colorWithAlphaComponent:0.5];
        ...
        hsLineView.backgroundColor = [UIColor blueColor];
        ...
        zhLineView.backgroundColor = [UIColor orangeColor];
...
-(UIView *)lowMenuView{
    ...
    if (!_lowMenuView) {
        ...
        _lowMenuView.backgroundColor = [[UIColor greenColor] colorWithAlphaComponent:0.5];
    }
