...
- (void)_registerTagStartHandlers
{
	...
	void (^h3Block)(void) = ^
	{
        ...
        _currentTag.textColor = DTColorCreateWithHTMLName(@"#4c4c4c");
        DTCoreTextFontDescriptor *defaultFontDescriptor = [[DTCoreTextFontDescriptor alloc] initWithFontAttributes:nil];
        defaultFontDescriptor.pointSize = 18;
        defaultFontDescriptor.boldTrait = YES;
        _currentTag.fontDescriptor = defaultFontDescriptor;
        defaultFontDescriptor = nil;
	};
